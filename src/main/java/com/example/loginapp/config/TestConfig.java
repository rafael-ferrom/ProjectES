...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Bula b3 = new Bula("Amoxicilina", "Amoxicilina tri-hidratada", "500mg", "Cápsula", "Caixa com 15 cápsulas", "Neo Química");
    ...
    Bula b7 = new Bula("Buscopan", "Butilbrometo de escopolamina", "10mg", "Comprimido", "Caixa com 20 comprimidos", "Boehringer Ingelheim");
